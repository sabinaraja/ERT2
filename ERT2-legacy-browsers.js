...
function PracticeFacesRoutineBegin(snapshot) {
  return async function () {
    ...
    PracticeFacesComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PracticeResponseRoutineBegin(snapshot) {
  return async function () {
    ...
    PracticeResponseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function FaceStimuliRoutineBegin(snapshot) {
  return async function () {
    ...
    FaceStimuliComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EmotionResponseRoutineBegin(snapshot) {
  return async function () {
    ...
    EmotionResponseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EndMessageRoutineBegin(snapshot) {
  return async function () {
    ...
    EndMessageComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
